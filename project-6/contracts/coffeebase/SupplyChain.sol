...
contract SupplyChain is Ownable, ConsumerRole, RetailerRole, DistributorRole, FarmerRole  {
  ...
  modifier onlyowner {
    require(msg.sender == spcContractOwner);
    _;
  }
  ...
  function kill() public {
    if (msg.sender == spcContractOwner) {
      selfdestruct(spcContractOwner);
    }
  }
  ...
  ) 
  {
    ...
    string memory pNotes = items[_upc].productNotes;
    Item memory item = items[_upc];
